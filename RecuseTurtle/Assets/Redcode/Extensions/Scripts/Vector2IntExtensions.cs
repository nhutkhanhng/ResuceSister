...
namespace Redcode.Extensions
{
    public static class Vector2IntExtensions
    {
        ...
        public static int MaxComponentIndex(this Vector2Int vector) => vector.x >= vector.y ? 0 : 1;
        ...
        public static int MaxComponent(this Vector2Int vector) => vector[MaxComponentIndex(vector)];
        ...
        public static int MinComponentIndex(this Vector2Int vector) => vector.x <= vector.y ? 0 : 1;
