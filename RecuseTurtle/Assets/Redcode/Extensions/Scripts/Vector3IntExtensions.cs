...
namespace Redcode.Extensions
{
    public static class Vector3IntExtensions
    {
        ...
        public static int MaxComponentIndex(this Vector3Int vector) => CompareAllComponents(vector, 1);
        ...
        public static int MaxComponent(this Vector3Int vector) => vector[MaxComponentIndex(vector)];
        ...
        public static int MinComponentIndex(this Vector3Int vector) => CompareAllComponents(vector, -1);
        ...
        public static int MinComponent(this Vector3Int vector) => vector[MinComponentIndex(vector)];
