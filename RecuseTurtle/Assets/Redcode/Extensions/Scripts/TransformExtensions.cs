...
namespace Redcode.Extensions
{
    public static class TransformExtensions
    {
        ...
        public static List<Transform> GetAllSiblingObjects(this Transform transform)
        {         
            if (transform.parent)
                return transform.parent.GetChilds();

            return transform.gameObject.scene.GetRootGameObjects().Select(o => o.transform).ToList();
        }
