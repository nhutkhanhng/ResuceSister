...
namespace Redcode.Extensions
{
    public static class Vector4Extensions
    {
        ...
        public static int MaxComponentIndex(this Vector4 vector) => CompareAllComponents(vector, 1);
        ...
        public static float MaxComponent(this Vector4 vector) => vector[MaxComponentIndex(vector)];
        ...
        public static int MinComponentIndex(this Vector4 vector) => CompareAllComponents(vector, -1);
        ...
        public static float MinComponent(this Vector4 vector) => vector[MinComponentIndex(vector)];
