...
namespace Redcode.Extensions
{
    public static class IEnumerableExtensions
    {
        ...
        /// <summary>
        /// Get random element index with probability.
        /// </summary>
        ...
        public static int GetRandomElementIndexWithProbability<T>(this IEnumerable<T> enumerable, params float[] probabilities) => GetRandomElementIndexWithProbability(enumerable, (IEnumerable<float>)probabilities);

        /// <summary>
        /// <inheritdoc cref="GetRandomElementIndexWithProbability{T}(IEnumerable{T}, float[])"/>
        /// </summary>
        /// <typeparam name="T"><inheritdoc cref="GetRandomElementIndexWithProbability{T}(IEnumerable{T}, float[])"/></typeparam>
        /// <param name="enumerable"><inheritdoc cref="GetRandomElementIndexWithProbability{T}(IEnumerable{T}, float[])" path="/param[@name='enumerable']"/></param>
        /// <param name="probabilities"><inheritdoc cref="GetRandomElementIndexWithProbability{T}(IEnumerable{T}, float[])" path="/param[@name='probabilities']"/></param>
        /// <returns>Random element.</returns>
        /// <exception cref="ArgumentException">Throwed when <paramref name="enumerable"/> and <paramref name="probabilities"/> counts are not match.</exception>
        public static int GetRandomElementIndexWithProbability<T>(this IEnumerable<T> enumerable, IEnumerable<float> probabilities)
        {
            if (probabilities.Count() != enumerable.Count())
        ...
        /// <summary>
        /// Get random element with probability.
        /// </summary>
        /// <typeparam name="T">Enumerable elements type.</typeparam>
        /// <param name="enumerable">The enumerable.</param>
        /// <param name="probabilities">Probabilities, must match in count with enumerable.</param>
        /// <returns>Random element.</returns>
        /// <exception cref="ArgumentException">Throwed when <paramref name="enumerable"/> and <paramref name="probabilities"/> counts are not match.</exception>
        public static T GetRandomElementWithProbability<T>(this IEnumerable<T> enumerable, params float[] probabilities) => GetRandomElementWithProbability(enumerable, (IEnumerable<float>)probabilities);
        ...
        /// <returns>Random element.</returns>
        /// <exception cref="ArgumentException">Throwed when <paramref name="enumerable"/> and <paramref name="probabilities"/> counts are not match.</exception>
        public static T GetRandomElementWithProbability<T>(this IEnumerable<T> enumerable, IEnumerable<float> probabilities)
        {
            return enumerable.ElementAt(GetRandomElementIndexWithProbability(enumerable, probabilities));
        }
